...
for index = 1:num_to_plot
    ...
    to_plot{index,2}
    to_plot{index,3}
    file = sprintf('SC_Regulation_%s_%ik_%iOhm.dat',to_plot{index,1},to_plot{index,2},to_plot{index,3})
    ...
    hold on;
    legend_info{index} = sprintf('%s %ik %iOhm',to_plot{index,1},to_plot{index,2},to_plot{index,3});
end
